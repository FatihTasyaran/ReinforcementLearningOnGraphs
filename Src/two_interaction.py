...
def q_learn_2_interaction(rewards1, rewards2, framework_graph, graph, q_table, start):
...
def main():
    ...
    q_tot, q_found, eps = q_learn_2_interaction(rewards1, rewards2, framework_graph, graph, q_table, 0)
    #####ONE EXPERIMENT RUNTIME Q_LEARN####
